                    ...
                    <form action="EditPost.php?Edit=<?php echo $SearchQueryParameter; ?>" method="post" enctype="multipart/form-data">
                        <fieldset>
                          <div class="form-group">
                            ...
                            <input value="<?php echo $Title_To_Update; ?>" class="form-control" type="text" name="Title" id="title">
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <textarea cols="30" rows="10" class="form-control" name="Post" id="postarea">
